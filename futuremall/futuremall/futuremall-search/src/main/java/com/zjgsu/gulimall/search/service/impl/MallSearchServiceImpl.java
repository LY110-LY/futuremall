...
import com.zjgsu.gulimall.search.feign.ProductFeignService;
import com.zjgsu.gulimall.search.service.MallSearchService;
import com.zjgsu.gulimall.search.vo.AttrResponseVo;
import com.zjgsu.gulimall.search.vo.BrandVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    private SearchRequest buildSearchRequest(SearchParam param) {
        ...
        SearchSourceBuilder sourceBuilder = new SearchSourceBuilder();//构建DSL语句的SearchSourceBuilder
        ...
        if(param.getAttrs() != null && param.getAttrs().size() > 0){
            ...
            param.getAttrs().forEach(item -> {
                ...
                nestedboolQuery.filter(nestedQueryBuilder);
            });
